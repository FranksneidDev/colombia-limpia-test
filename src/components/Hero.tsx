    ...
    <header className="overflow-hidden bg-slate-100 lg:bg-transparent lg:px-5">
      <div className="mx-auto grid max-w-6xl grid-cols-1 grid-rows-[auto_1fr] gap-y-16 pt-16 md:pt-20 lg:grid-cols-12 lg:gap-y-20 lg:px-3 lg:pt-20 lg:pb-36 xl:py-32">
        <div className="relative flex items-end lg:col-span-5 lg:row-span-2">
          ...
          <div className="hidden relative z-10 mx-auto lg:flex lg:h-80 h-64 w-full rounded-xl bg-slate-600 shadow-xl md:w-full lg:w-auto">
            <Image
        ...
        <div className="bg-white pt-16 lg:col-span-7 lg:bg-transparent lg:pt-0 lg:pl-16 xl:pl-20">
          <div className="mx-auto px-4 sm:px-6 md:max-w-2xl md:px-4 lg:px-0">
            <h1 className="font-display text-5xl font-extrabold text-slate-900 sm:text-6xl">
              Colombia Limpia Soluciones S.A.S.
            </h1>
            <p className="mt-4 text-3xl text-slate-600">
              Expertos en aseo, mantenimiento y seguridad, brindamos soluciones
              integrales con calidad y eficiencia para tu empresa o comunidad.
            </p>
